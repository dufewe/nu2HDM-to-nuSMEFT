...
{WE["(6)", "l\[Nu]\[Nu]l", "scalar"][p, r, s, t] -> 0, 
 ...
 WC["(4)", "H"] -> (3*\[Lambda]6*Conjugate[\[Lambda]6])/(8*Pi^2), 
 ...
 WC["(6)", "GTilde"] -> 0, WC["(6)", "H"] -> 
  -1/16*(7*\[Lambda]6^2*Conjugate[\[Lambda]5] + Conjugate[\[Lambda]6]*
      ((-17*\[Lambda]1 + 12*\[Lambda]3 + 13*\[Lambda]4)*\[Lambda]6 + 
       7*\[Lambda]5*Conjugate[\[Lambda]6]))/(m22^2*Pi^2), 
 WC["(6)", "HBox"] -> (-3*\[Lambda]6*Conjugate[\[Lambda]6])/(32*m22^2*Pi^2), 
 ...
 WC["(6)", "uH"][p, r] -> 
  (-((3*\[Lambda]3 + 4*\[Lambda]4)*\[Lambda]6*Yuk[U2][p, r]) + 
    Conjugate[\[Lambda]6]*(\[Lambda]6*Yuk[U1][p, r] - 
 ...
 WCC["(6)", "\[Nu]H"][p, r] -> 
  (-5*\[Lambda]6*Conjugate[\[Lambda]5]*ConjugateTranspose[Yuk[\[Nu]2]][p, 
      r] + Conjugate[\[Lambda]6]*(\[Lambda]6*ConjugateTranspose[Yuk[\[Nu]1]][
        p, r] - (3*\[Lambda]3 + 4*\[Lambda]4)*ConjugateTranspose[Yuk[\[Nu]2]][
        p, r]))/(16*m22^2*Pi^2), WCC["(6)", "eH"][p, r] -> 
  (-((3*\[Lambda]3 + 4*\[Lambda]4)*\[Lambda]6*ConjugateTranspose[Yuk[E2]][p, 
       r]) + Conjugate[\[Lambda]6]*
     (\[Lambda]6*ConjugateTranspose[Yuk[E1]][p, r] - 
      5*\[Lambda]5*ConjugateTranspose[Yuk[E2]][p, r]))/(16*m22^2*Pi^2), 
 WCC["(6)", "uH"][p, r] -> 
  ...
  (-((3*\[Lambda]3 + 4*\[Lambda]4)*\[Lambda]6*ConjugateTranspose[Yuk[D2]][p, 
       r]) + Conjugate[\[Lambda]6]*
     (\[Lambda]6*ConjugateTranspose[Yuk[D1]][p, r] - 
      5*\[Lambda]5*ConjugateTranspose[Yuk[D2]][p, r]))/(16*m22^2*Pi^2), 
 ...
 WCC["(6)", "\[Nu]edu"][p, r, s, t] -> 0, WC["(6)", "l\[Nu]"][p, r, s, t] -> 
  0, WC["(6)", "le"][p, r, s, t] -> 0, WC["(6)", "lu"][p, r, s, t] -> 0, 
 WC["(6)", "ld"][p, r, s, t] -> 0, WC["(6)", "q\[Nu]"][p, r, s, t] -> 0, 
 WC["(6)", "qe"][p, r, s, t] -> 0, WC["(6)", "qu", "(1)"][p, r, s, t] -> 0, 
 WC["(6)", "qu", "(8)"][p, r, s, t] -> 0, 
 WC["(6)", "qd", "(1)"][p, r, s, t] -> 0, 
 WC["(6)", "qd", "(8)"][p, r, s, t] -> 0, 
