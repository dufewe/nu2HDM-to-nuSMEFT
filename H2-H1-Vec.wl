...
{WE["(6)", "l\[Nu]\[Nu]l", "scalar"][p, r, s, t] -> 0, 
 ...
 WC["(6)", "H"] -> ((3*g2^2 + 4*g1^2*YH^2)*\[Lambda]6*Conjugate[\[Lambda]6])/
   (64*m22^2*Pi^2), WC["(6)", "HBox"] -> 0, WC["(6)", "HD"] -> 0, 
 WC["(6)", "HG"] -> 0, WC["(6)", "HW"] -> 0, WC["(6)", "HB"] -> 0, 
 WC["(6)", "HWB"] -> 0, WC["(6)", "HGTilde"] -> 0, WC["(6)", "HWTilde"] -> 0, 
 WC["(6)", "HBTilde"] -> 0, WC["(6)", "HWTildeB"] -> 0, 
 WC["(6)", "\[Nu]H"][p, r] -> ((3*g2^2 + 4*g1^2*YH^2)*\[Lambda]6*
    Yuk[\[Nu]2][p, r])/(64*m22^2*Pi^2), WC["(6)", "eH"][p, r] -> 
  ((3*g2^2 + 4*g1^2*YH^2)*Conjugate[\[Lambda]6]*Yuk[E2][p, r])/
   (64*m22^2*Pi^2), WC["(6)", "uH"][p, r] -> 
